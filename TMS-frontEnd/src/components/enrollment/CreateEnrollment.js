...
function CreateEnrollment(props) {
    ...
    // Storing comments
    const [enrollmentValues, setEnrollmentValues] = useState({  first_name: "",last_name: "",gender: "",date_of_birth: "",address_line_1: "",address_line_2: "",city: "",district: "",state: "",zip_Code: "",phone: "",email_address: "",highest_qualification: "",skill_set: "",current_company_name: "",current_designation: "",ictak_course_handling: "",});
    ...
    async function createEnrollment() {
      ...
      console.log("Calling create enrollment service with body " + formData)
        ...
        const respBody = await response.json().then (
            navigation("/") );
            console.log("Backend call successfully completed with response  : " + respBody)
    }
    ...
    return (
       ...
       <div className="wrapper">
          ...
          <label className="form-group">
          <select name="gender" className="form-control course_selection" value={enrollmentValues.gender} onChange={handleSelectChange} required>
          ...
          <label className="form-group">
          <select name="ictak_course_handling" className="form-control course_selection" value={enrollmentValues.ictak_course_handling.value} onChange={handleSelectChange} required>
        ...
        {/* <fieldset> */}
        <label className="form-group">
        <input type="file"  id="imageInput"  className="form-control" name="image" accept=".jpg,.png" />
						<span>    Photo *</span>
        ...
        <div className="btns">
          ...
          <button  onClick={createEnrollment} value="Submit application" > Submit </button>
        </div>
				</form>
			</div>
		</div>
